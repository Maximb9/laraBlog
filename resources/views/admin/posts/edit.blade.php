                        ...
                        <form role="form" method="post" action="{{ route('posts.update', ['post' => $post->id]) }}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="tags[]" class="form-control select2" style="width: 100%;" id="tags" multiple="multiple" data-placeholder="Выбор тегов">
                                        @foreach($tags as $k => $v)
                                ...
                                <div><img src="{{ $post->getImage() }}" width="200" height="200" alt="photo" class="img-thumbnail"></div>
                            </div>
                            <!-- /.card-body -->
